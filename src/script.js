...
import * as Fonts from 'three/examples/jsm/loaders/FontLoader'
import * as Texts from 'three/examples/jsm/geometries/TextGeometry'
...
const fontLoader = new Fonts.FontLoader()
fontLoader.load(
    '/fonts/helvetiker_regular.typeface.json',
   (font)=>{
    const textGeometry = new Texts.TextGeometry(
        'Souda Achref',
        {
            font:font,
            size:0.5,
        ...
        for (let i=0;i<500;i++){
            ...
            const scale = Math.max(Math.random(),0.4)
